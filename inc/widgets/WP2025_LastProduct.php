<?php
class WP2025_LastProduct extends WP_Widget {
    public function __construct() {
		// actual widget processes
        parent::__construct(
			'WP2025_LastProduct', // Base ID
			'WP2025_LastProduct', // Name
			[
                'description' => __( 'Widget hiển thị các sản phẩm mới nhất', 'wp2025-theme' )
            ] // Args
		);
	}
